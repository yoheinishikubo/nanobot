...
def test_importing_providers_package_is_lazy(monkeypatch) -> None:
    ...
    monkeypatch.delitem(sys.modules, "nanobot.providers.github_copilot_cli_provider", raising=False)
    ...
    assert "nanobot.providers.github_copilot_cli_provider" not in sys.modules
